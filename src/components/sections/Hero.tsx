      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-lg border border-white/20 shadow-[0_4px_30px_rgba(0,0,0,0.1)] mb-6 transition-colors hover:bg-white/20"
          >
            <span className="w-2 h-2 rounded-full bg-brand-400 animate-pulse shadow-[0_0_8px_rgba(74,222,128,0.8)]" />
            <span className="text-sm font-semibold tracking-wide text-white uppercase drop-shadow-md">
          ...
          >
            Custom tours covering Munnar, Alleppey, Kochi &amp; more.
            Transparent pricing, local guides, and customizable itineraries
          ...
          <motion.div variants={itemVariants} className="flex flex-wrap gap-4 items-center">
            <Link href="/packages">
              <motion.span
                ...
                whileTap={{ scale: 0.97 }}
                className="group inline-flex items-center gap-2 bg-brand-500 text-white px-8 py-4 rounded-full font-semibold shadow-[0_4px_20px_rgba(34,197,94,0.4)] hover:bg-brand-400 transition-colors cursor-pointer"
              >
                View Packages
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center gap-2 bg-whatsapp hover:bg-whatsapp-dark text-white border border-white/20 px-8 py-4 rounded-full font-semibold transition-colors shadow-lg cursor-pointer"
            >
